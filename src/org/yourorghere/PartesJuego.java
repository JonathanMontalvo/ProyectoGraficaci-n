    ...
    public void velocidades()
    {
        while (repetir < 240) {
            try {
                ...
                juego();
                sleep(40); //Esperar 42 milisegundos antes de la siguiente iteraci髇
                repetir++;
        ...
        while (repetir < 720) {
            try {
                ...
                juego();
                sleep(26); //Esperar 10 milisegundos antes de la siguiente iteraci髇
                repetir++;
            } catch (InterruptedException ex) {
                Logger.getLogger(PartesJuego.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        while (repetir < 975) {
            try {
                ...
                juego();
                sleep(22); //Esperar 10 milisegundos antes de la siguiente iteraci髇
                repetir++;
            } catch (InterruptedException ex) {
                Logger.getLogger(PartesJuego.class.getName()).log(Level.SEVERE, null, ex);
            }
